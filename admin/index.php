...
?>
<center><p style="font-size:25px; color:#FFFFFF;">FORMulario DE INSCRIPCIÓN
</p></center>
<span style="color:#FFFFFF;font-size:20px;margin-left:30px">Nombre de usuario </span><input type="text" placeholder="Name"  required class="a" name="username"/><br/>
<br/>
<span style="color:#FFFFFF;font-size:20px;margin-left:30px;">Password </span><input  type="Password" placeholder="Password " required class="a" name="password"/><br/><br/>
 <input class="b" type="submit" name="s" value ="Sign up" /><a href="new.php">Registrado aquí</a></div>
